...
public abstract class DrillJoinRelBase extends Join implements DrillJoin {
  ...
  public double estimateRowCount(RelMetadataQuery mq) {
    ...
    if ((((int)PrelUtil.getPlannerSettings(this.getCluster().getPlanner()).getStatisticsJoinCardinalityMode() & 1) == 1)
        && !DrillRelOptUtil.guessRows(this)         //Statistics present for left and right side of the join
